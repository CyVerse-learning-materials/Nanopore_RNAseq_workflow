...
In this quick start, we will show you how to analyze Oxford Nanopore Technology (ONT) long read sequencing in CyVerse's Discovery Environment (DE)
...
.. list-table::
    ...
    * - Input File(s)
      - Format
      - Preparation/Notes
      - Example Data can be found at in the Discovery Environment at /iplant/home/shared/iplantcollaborative/example_data/VICE/Nanopore_RNAseq_workflow (paste this into the DE browser)
    * - Sequencing reads from Nanopore, basecalled, in FASTq format
      ...
      - Any sequencing reads in FastQ format will work. They do not
        ...
        fastq.gz)
      - Either a genome and genome annotation file for your species of interest - or - a FASTA file of transcripts from your species
